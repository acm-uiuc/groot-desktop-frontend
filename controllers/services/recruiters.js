...
module.exports = function(app) {
  ...
  app.put('/corporate/students/:netid/approve', function(req, res) {
    ...
    var absResumePath = path.resolve('views/_partials/unapproved_resumes.ejs');
    request({
  ...
  app.put('/corporate/jobs/:jobId/approve', function(req, res) {
    ...
    var absJobPath = path.resolve('views/_partials/unapproved_jobs.ejs');
    request({
  ...
  app.put('/corporate/accounts/:recruiterId/renew', function(req, res) {
    ...
    var absRecruiterPath = path.resolve('views/_partials/recruiters.ejs');
    request({
